...
public interface ICustomerRepository extends JpaRepository<Customer, Integer> {
    ...
    @Query(value = "select * from customer where name like :nameSearch and customer_type_id = :id", nativeQuery = true)
    List<Customer> search(@Param("nameSearch") String nameSearch, @Param("id") int id);
}
